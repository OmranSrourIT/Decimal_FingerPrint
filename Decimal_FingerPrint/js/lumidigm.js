...
var FPConfig = Omnix.FPConfig = {
    GetFPImage: "http://172.16.2.103/PisWebPages/OmnixLumidigm/GetFPImage.ashx",
    //GetFPImage: "http://localhost:41285/GetFPImage.ashx",
    //FPTemplate: "http://172.16.2.103/PisWebPages/OmnixLumidigm/FPTemplate.ashx",
    //FileUploader: "http://172.16.2.103/PisWebPages/OmnixLumidigm/fileUploader.ashx",
    //FileUploader: "http://172.16.2.103/PisWebPages/OmnixLumidigm/FPVerifyResult.ashx",
    UserBindAuth: "http://172.16.2.103/PisWebPages/OmnixLumidigm/UserBindAuth.ashx",
    //UserBindAuth: "http://localhost:41285/UserBindAuth.ashx"
};
...
Lumidigm.prototype = {
	...
	verifycrm: function (sensorId, caseId, fingerIndex, fileDescription) {
	    console.log('call verifycrm: ');
	    return JSON.parse(opost(this.baseurl + '/verifycrm', { "sensorId": sensorId, "caseId": caseId, "fingerIndex": fingerIndex, "fileDescription": fileDescription }));
	},
    ...
    uploadtohttp: function () {
        console.log('call UploadtoHttpServer: ');
    return JSON.parse(opost(this.baseurl + '/UploadtoHttpServer'));
}
	/*,
	...
	//	console.log('call addFingerprint: See below to know What We send to siebel when save attachment to siebel siebel');
	//	console.log(base64);
	//	console.log(fileDescARA);
	//	console.log(caseId);
	//	console.log(fileExt);
	//	console.log(fingerOwner);
	...
	//}
	//,
	//checkFBAttachment: function(caseId,fingerOwner) {
	
	//console.log('call checkFBAttachment');
	
	//return JSON.parse(opost('http://172.16.2.103/pisservices/invokeSiebel/sfs.svc/rest/checkFBAttachment', { "caseId":caseId,"fingerOwner":fingerOwner }));
	...
	//},
	//updateFlagForFailedFB: function(caseId)
	//{
	//	console.log('invoke updateFlagForFailedFB');
		
	//	return JSON.parse(opost('http://172.16.2.103/pisservices/invokeSiebel/sfs.svc/rest/updateFlagForFailedFB', { "caseId":caseId }));
	//}
...
//last update 2016/11/21*********10:26 AM